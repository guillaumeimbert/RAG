...
-- dimension MUST match EMBEDDING_DIM in .env (default 768 = nomic-embed-text).
...
-- ANN index: cosine similarity (embeddings are assumed L2-normalized or not;
-- cosine ops handles both)
